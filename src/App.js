							...
							<div className="space-y-6">
								...
								<div className="flex items-center space-x-4">
									...
									<div>
										...
										<p className="text-xl text-gray-200">Bhubaneswar, Odisha</p>
									</div>
								</div>
							</div>
							...
							<div className="bg-gray-700/50 p-6 rounded-xl flex flex-col items-center">
								...
								<ul className="space-y-3 text-gray-300 w-full max-w-md">
									<li className="border-l-2 border-blue-400 pl-4">
										...
										<div className="text-gray-400">CGPA: 8.2</div>
									</li>
									<li className="border-l-2 border-blue-400 pl-4">
										<div className="font-semibold text-base">
										...
										<div className="text-gray-400">Aggregate: 93.7%</div>
									</li>
									<li className="border-l-2 border-blue-400 pl-4">
										<div className="font-semibold text-base">
							...
							<div className="bg-gray-700/50 p-6 rounded-xl flex flex-col items-center">
								...
								<ul className="space-y-3 text-gray-300 w-full max-w-md">
									<li className="flex items-start space-x-3">
										...
										<span>
											Third-year Computer Science student at KIIT with a strong
